...
final class CreatingIrregularEvent: UIViewController, UICollectionViewDelegate {
...
extension CreatingIrregularEvent {
...
extension CreatingIrregularEvent: UICollectionViewDataSource {
...
extension CreatingIrregularEvent: UICollectionViewDelegateFlowLayout {
...
extension CreatingIrregularEvent {
    ...
    func layoutColors() {
        ...
        NSLayoutConstraint.activate([
            colorCollectionView.topAnchor.constraint(equalTo: categoryButton.bottomAnchor, constant: 270),
...
extension CreatingIrregularEvent: CategoryListViewModelDelegate {
